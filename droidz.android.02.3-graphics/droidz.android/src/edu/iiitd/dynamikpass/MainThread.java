...
//	private static final String MyPREFERENCES = null;
	...
	public void doSubmit() {
		...
		synchronized (surfaceHolder) {
			...
			if(RegistrationPanel.SelectRed()!= null){
				droidr = RegistrationPanel.SelectRed();
			...
			if(RegistrationPanel.SelectGreen()!= null){
				droidr = RegistrationPanel.SelectGreen();
			...
			if(RegistrationPanel.SelectYellow()!= null){
				droidr = RegistrationPanel.SelectYellow();
